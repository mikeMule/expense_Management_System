...
class Transaction {
    ...
    public function addTransaction($type, $category_id, $amount, $description, $transaction_date, $notes = '') {
        $this->db->query('INSERT INTO transactions (type, category_id, amount, description, transaction_date, notes) 
                          VALUES (:type, :category_id, :amount, :description, :transaction_date, :notes)');
